		...
		<section id="content">
			...
			<div class="container">
				...
				<div class="sixteen columns">
					...
					<?php if (is_category()) { ?>
						<h1 class="archive-title"><?php _e('Posts in the Category:', 'nash'); ?> <?php single_cat_title(); ?></h1>
					...
					<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
						...
						<article <?php post_class("post-excerpt"); ?>>
							...
							<span class="meta-category"><?php _e('Posted in', 'nash'); ?> - <?php the_category(' & '); ?> <?php _e('on', 'nash'); ?> <strong><?php echo get_the_date($d); ?></strong> <span class="comment-count"><a href="<?php the_permalink(); ?>#comments"><?php $commentscount = get_comments_number(); echo $commentscount; ?></a> <?php _e('Comments', 'nash'); ?></span></span> 

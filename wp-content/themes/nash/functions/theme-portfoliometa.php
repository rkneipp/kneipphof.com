...
$meta_box_portfolio = array(
	...
	'title' =>  __('Portfolio Detail Settings', 'nash'),
	'page' => 'portfolio',
	'context' => 'normal',
	'priority' => 'high',
	'fields' => array(
    	array(
			'name' =>  __('Portfolio Type', 'nash'),
			'desc' => __('Choose the type of portfolio you wish to display.', 'nash'),
		...
		array(
    	   'name' => __('Client Name', 'nash'),
    	   'desc' => __('Client who this project was completed for', 'nash'),
    	   'id' => $prefix . 'client_name',
    	   'type' => 'text',
    	   'std' => ''
    	),
    	array(
    	   'name' => __('Project Date', 'nash'),
    	   'desc' => __('What was the date of the completed project', 'nash'),
    	   'id' => $prefix . 'project_date',
    	   'type' => 'text',
    	   'std' => ''
    	),
    	array(
    	   'name' => __('Project Checklist', 'nash'),
    	   'desc' => __('Create a checklist of skills used on the project<br />(ie; Branding, Responsive Design, Strategy Planning etc...)', 'nash'),
    	   'id' => $prefix . 'project_checklist',
    	   'type' => 'textarea',
    	   'std' => ''
    	),
    	array(
    	   'name' => __('Project URL', 'nash'),
    	   'desc' => __('What is the URL for this project', 'nash'),
...
$meta_box_portfolio_portfolio_video = array(
	...
	'title' => __('Video Settings', 'nash'),
	'page' => 'portfolio',
	'context' => 'normal',
	'priority' => 'high',
	'fields' => array(
		array(
			'name' => __('Video Embed Code', 'nash'),
			'desc' => __('If you are using video from somewhere like YouTube, Vimeo etc... Please paste the embed code here. Width should be at least 960px with any height.<br><br>', 'nash'),
	...
	foreach ($meta_box_portfolio_portfolio_image['fields'] as $field) {
		...
		switch ($field['type']) {
			...
			?>
				...
				jQuery(function($) {
					...
					$('#gt_images_upload').on('click', function(e) {
						...
						var options = {
							title: '<?php _e("Create Featured Gallery", "nash"); ?>',
							state: 'gallery-edit',
							frame: 'post',
							selection: selection
						};
						...
						if( frame || selection ) {
							options['title'] = '<?php _e("Edit Featured Gallery", "nash"); ?>';
						}
						...
						frame.menu.get('view').get('gallery-edit').el.innerHTML = '<?php _e("Edit Featured Gallery", "nash"); ?>';
						...
						function overrideGalleryInsert() {
    						frame.toolbar.get('view').set({
								insert: {
									style: 'primary',
									text: '<?php _e("Save Featured Gallery", "nash"); ?>',
									...
									click: function() {
										...
										this.el.innerHTML = '<?php _e("Saving...", "nash"); ?>';
			...
			<?php
				...
				$thumbs_output = '';
				$button_text = ($meta) ? __('Edit Gallery', 'nash') : $field['std'];
				if( $meta ) {
					$field['std'] = __('Edit Gallery', 'nash');
					$thumbs = explode(',', $meta);
					$thumbs_output = '';

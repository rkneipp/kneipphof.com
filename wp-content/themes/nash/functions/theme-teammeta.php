...
$meta_box_team = array(
	'id' => 'team_member',
    'title' => __('Team Member Details', 'nash'),
    'page' => 'team',
    'context' => 'normal',
    'priority' => 'high',
    'fields' => array(
        array(
        	'name' =>  __('Job Title', 'nash'),
            'desc' => __('Enter a job title for the Team Member <br />(ie; The Boss or Managing Director)', 'nash'),
            'id' => $prefix . 'member_title',
            'type' => 'text',
            'std' => ''
        ),
        array(
           'name' => __('Twitter', 'nash'),

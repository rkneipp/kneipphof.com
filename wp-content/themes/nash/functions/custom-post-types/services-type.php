...
function services_register() {
    $labels = array(
        'name' => __('Services', 'nash'),
        'add_new' => __('Add New', 'nash'),
        'add_new_item' => __('Add New Service', 'nash'),
        'edit_item' => __('Edit Service Item', 'nash'),
        'new_item' => __('New Service Item', 'nash'),
        'view_item' => __('View Service Item', 'nash'),
        'search_items' => __('Search Service Items', 'nash'),
...
function services_help_text($contextual_help, $screen_id, $screen) {
    if ('services' == $screen->id) {
        $contextual_help =
        '<h3>' . __('Things to remember when adding a Service:', 'nash') . '</h3>' .
        '<ul>' .
        '<li>' . __('Give the Service a title. (ie; Website Development or Development from the best in the game).', 'nash') . '</li>' .
        '<li>' . __('Add a short excerpt to describe your service.', 'nash') . '</li>' .
        '</ul>';
    }
    elseif ('edit-services' == $screen->id) {
        $contextual_help = '<p>' . __('A list of all services items appear below. To edit an item, click on the items title.', 'nash') . '</p>';
    }
...
?>
    ...
    <h2><?php _e('Sort Service Items', 'nash'); ?> <img src="<?php echo home_url(); ?>/wp-admin/images/loading.gif" id="loading-animation" /></h2>
    <p><?php _e('Click, drag, re-order. Repeat as neccessary. Service item at the top will appear first on your page.', 'nash'); ?></p>
    <ul id="post-list">

...
$meta_box_quotes = array(
        ...
        'fields' => array(
        	array(
        		'name' => __('Quote', 'nash'),
        	    'desc' => __('Enter a short quote or testimonial', 'nash'),
        	    'id' => $prefix . 'quotes_quote',
        	    'type' => 'text',
        	    'std' => ''
        	),
            array(
            	'name' => __('Author Name', 'nash'),
                'desc' => __('Enter the author name of the above quote <br />(ie; Orson Welles)', 'nash'),

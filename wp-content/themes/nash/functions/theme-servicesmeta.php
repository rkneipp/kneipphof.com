...
$meta_box_service = array(
	'id' => 'service_details',
    'title' => __('Service Details', 'nash'),
    'page' => 'services',
    'context' => 'normal',
    'priority' => 'high',
    'fields' => array(
        array(
        	'name' => __('Service Icon', 'nash'),
            'desc' => __('Add an Icon for your service via Shortcode <br />Example: [icon name=icon-file]<br /><br />A list of all available icons can be found <a href="http://fortawesome.github.com/Font-Awesome" target="_blank">here</a>', 'nash'),
